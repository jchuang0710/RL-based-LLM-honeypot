...
original_reward = "rewards_04-23-09.txt"
rl_reward = "rewards_04-22-23.txt"
absi_reward = "rewards_04-22-20.txt"
...
colors = mpl.colormaps['viridis_r'](np.linspace(0, 1, 8))  # 用 viridis, 自動取色
...
plt.tight_layout()
fig.savefig(fname='./' + 'Attack_Depth_Windows' + '.png', format='png')
plt.show()
